...
class AlarmCallBot:
    ...
    def call(self, message: telebot.types.Message) -> None:
    ...
    def new_channel_post(self, message: telebot.types.Message) -> None:
    ...
    def set_phone(self, message: telebot.types.Message) -> None:
    ...
    def contact(self, message: telebot.types.Message) -> None:
